...
kanban
  ...
  next["📋 Planned"]
    bugp1["Bug fixes P1 — the 5 medium 07-19 hunt findings: blank-brief wake window · promptless scout add · frozen news category · UTC streak days · dev-vs-prod port clash"]
