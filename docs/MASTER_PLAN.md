...
kanban
  ...
  doing["🔄 In progress"]
    ...
    wave2["Wave 2 — correctness<br/>sweep: 14 low bugs +<br/>hardens + FR10 ·<br/>batches 1-4 done PRs<br/>87 89 90 91 ·<br/>remaining: store ·<br/>notes UX"]
  next["📋 Planned"]
...
2. **Wave 2 — correctness sweep**: the 14 non-courses bug lows + the 4 hardens + FR10 (the 4
   ...
   **Batch 4 (offline/PWA honesty) ✅ shipped 2026-07-19, PR #91**: #15 sw.js audio-date
   ...
   per-request dist check (make build needs no restart). Remaining: store · notes UX.
