...
- Player learns `video`/`mindmap` step kinds — D6-honest: audio spine, videos supplementary
  under their real kind/artifact_type. Path data is gitignored user data, validated 32/32
  against the sidecar README and already live; frontend 214→215 · tsc green.
