...
kanban
  ...
  doing["🔄 In progress"]
    hbm6proof["HB M6 remainder — phone eyes-on evidence · 07-19 pass: standalone PASS · audio scrub PASS w/ log-corroborated 206s · airplane check FAILED then root-caused + fixed (sw.js v3, PR 71, deployed) — phone re-test pending · reboot survival at next login · Kyle"]
  next["📋 Planned"]
