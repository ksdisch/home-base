...
- Client half: a `pathFailed` flag renders "Couldn't load this topic's path just now." — honest about a read failure instead of offering to replace what it merely failed to read.
...
- RED shown first on all 8 tests (4 endpoint · 3 store · 1 card). Backend 919→926 · frontend 264→265 · ruff/tsc green.
