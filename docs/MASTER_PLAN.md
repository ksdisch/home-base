...
kanban
  ...
  next["📋 Planned"]
    trust["Trust + liveness<br/>cluster — ran-or-didnt<br/>banner QU12 ·<br/>sweep-trust gauge PR5<br/>· heartbeat outside<br/>the app PR12"]
    qnotes["Notes on News cards<br/>QU5 — cross-mode<br/>capture, serves the<br/>notes/week v1<br/>criterion"]
  decide["⏸️ Awaiting decision"]
  later["🧊 Later / parked"]
    defer["Kickoff-deferred: ESPN<br/>· auto-courses ·<br/>alerts · public<br/>writing"]
    moonshots["4 Moonshot bets —<br/>Overnight Chief of<br/>Staff · The Mirror ·<br/>Readiness Brief ·<br/>Calibrated Doubt<br/>wildcard"]
    quickwins["3 QuickWins parked —<br/>yesterdays brief QU1 ·<br/>audio resume QU3 ·<br/>topic chips QU4 — QU5<br/>+ QU12 already planned"]
    premortems["1 Premortem antibody<br/>parked — vault-ritual<br/>feed PR10 — heartbeat<br/>PR12 + trust gauge PR5<br/>ride the Planned trust<br/>cluster"]
    hardens["4 Harden guards —<br/>re-sweep note detach<br/>HA2 · untrusted<br/>framing HA4 ·<br/>feed-drift guard HA8 ·<br/>migration snapshot<br/>HA11"]
    frictions["5 Friction smoothings<br/>— nav survival FR15 ·<br/>phone sweep trigger<br/>FR2 · audio chapters<br/>FR4 · developing<br/>context FR13 · undo<br/>beat FR10"]
    buglows["18 low bug stubs —<br/>ranked with fixes in<br/>the 2026-07-19<br/>bug-hunt report ·<br/>BACKLOG Open section"]
```
