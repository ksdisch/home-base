...
kanban
  ...
  doing["🔄 In progress"]
    ...
    bugp1["Bug fixes P1 — the 5 medium 07-19 hunt findings · 2/5 fixed: blank-brief wake window PR 73 · promptless scout add PR 74 · next: frozen news category · UTC streak days · dev-vs-prod port clash"]
  next["📋 Planned"]
