...
_**Attributed 2026-07-27 (PR #158)** — the mornings count now ships with `mornings_phone` beside
...
### 2026-07-27 — Visit-source attribution: the habit metric stops certifying the robots (PR #158)
...
- Backend 793 → **829 passed** (+36, `test_visit_source.py`) · frontend 216 → **220**
