...
kanban
  ...
  doing["🔄 In progress"]
    ...
    bugp1["Bug fixes P1 — the 5 medium 07-19 hunt findings · 4/5 fixed: blank-brief wake window PR 73 · promptless scout add PR 74 · frozen news category PR 75 · UTC streak days PR 76 · next: dev-vs-prod port clash"]
  next["📋 Planned"]
  ...
  later["🧊 Later / parked"]
    ...
    replen["Replenish 2026-07-19: 21 captured ideas in docs/ideas incl. 4 moonshots + 18 low bug stubs — BACKLOG Open section"]
```
