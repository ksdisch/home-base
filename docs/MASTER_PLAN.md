...
kanban
  ...
  doing["🔄 In progress"]
    ...
    wave3["Wave 3 — walk and<br/>phone: QU3 audio<br/>resume done PR 95 ·<br/>next topic chips QU4<br/>→ nav survival FR15 →<br/>audio chapters FR4 →<br/>developing context<br/>FR13 → phone sweep<br/>trigger FR2 →<br/>yesterdays brief QU1"]
  next["📋 Planned"]
