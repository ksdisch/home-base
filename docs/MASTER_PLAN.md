...
- One deliberate behaviour trade-off, documented in the planner docstring: monotonic placement can
  ...
  path out of order. Backend 739→787 · frontend 195→197 · ruff/tsc/build green.
