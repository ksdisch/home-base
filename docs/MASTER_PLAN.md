...
rendered — the original "21/21" counted day-directories); those mornings served the prior day's
brief, and opens still counted toward the metric (visits stamp the visit day — F8), so only 5 of
the week's 7 mornings offered a fresh brief. Extended: two attributed weeks (08-03 → 08-16),
