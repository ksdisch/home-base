...
kanban
  ...
  doing["🔄 In progress"]
    ...
    wave2["Wave 2 — correctness<br/>sweep: 14 low bugs +<br/>hardens + FR10 ·<br/>batches 1-2 done PRs<br/>87 89 · remaining:<br/>news · offline · store<br/>· notes UX"]
  next["📋 Planned"]
...
2. **Wave 2 — correctness sweep**: the 14 non-courses bug lows + the 4 hardens + FR10 (the 4
   ...
   **Batch 2 (LLM-lane containment) ✅ shipped 2026-07-19, PR #89**: #10 full env-scrub
   ...
   (both lanes) · HA4 untrusted-data framing in both build_prompts. Remaining: news ·
