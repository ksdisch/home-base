...
kanban
  ...
  next["📋 Planned"]
    ...
    rep0726["Replenish 2026-07-26 —<br/>remainder RE-COUNTED<br/>2026-08-11 via<br/>/backlog-hygiene: bugs<br/>40 of 47 fixed, 7 open<br/>(#6 #11 #15 #16 #17 #18<br/>#19 — all S, none<br/>test-covered) · ideas 2<br/>open (roster-entropy ·<br/>feed-the-vault) · 4<br/>moonshots parked/gated<br/>D7-D10 · Arc C picked"]
    arcC["Arc C — concurrency +<br/>honesty on shipped<br/>surfaces: #16 Overnight<br/>double-tap can double a<br/>real note (docstring<br/>claims it cannot) · #11<br/>Progress blanks when one<br/>of four calls fails<br/>(contradicts its own<br/>intent comment) ·<br/>picked at the 08-11<br/>hygiene gate"]
