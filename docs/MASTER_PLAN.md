...
kanban
  ...
  doing["🔄 In progress"]
    ...
    bugp1["Bug fixes P1 — the 5 medium 07-19 hunt findings · 1/5 fixed: blank-brief wake window PR 73 · next: promptless scout add · frozen news category · UTC streak days · dev-vs-prod port clash"]
  next["📋 Planned"]
