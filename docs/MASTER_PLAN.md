...
kanban
  ...
  doing["🔄 In progress"]
    hbm6proof["HB M6 remainder — phone eyes-on evidence: home-screen standalone · airplane-mode banner · iOS audio scrub · reboot survival · Kyle · pass teed up 07-19: preflight green + checklist in docs/smoke"]
  next["📋 Planned"]
