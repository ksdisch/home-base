...
kanban
  ...
  doing["🔄 In progress"]
    ...
    wave2["Wave 2 — correctness<br/>sweep: 14 low bugs +<br/>hardens + FR10 ·<br/>batches 1-5 done PRs<br/>87 89 90 91 92 ·<br/>remaining: notes UX"]
  next["📋 Planned"]
...
2. **Wave 2 — correctness sweep**: the 14 non-courses bug lows + the 4 hardens + FR10 (the 4
   ...
   **Batch 5 (store safety) ✅ shipped 2026-07-19, PR #92**: HA11 unconditional
   ...
   bad-row-proof streak parsing. Remaining: notes UX.
