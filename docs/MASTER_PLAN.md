...
kanban
  ...
  doing["🔄 In progress"]
    ...
    bugp1["Bug fixes P1 — the 5 medium 07-19 hunt findings · 3/5 fixed: blank-brief wake window PR 73 · promptless scout add PR 74 · frozen news category PR 75 · next: UTC streak days · dev-vs-prod port clash"]
  next["📋 Planned"]
