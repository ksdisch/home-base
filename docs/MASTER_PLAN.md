...
kanban
  ...
  next["📋 Planned"]
    trust["Wave 1 — trust +<br/>liveness: didnt-run<br/>banner QU12 ✅ PR 82 →<br/>sweep-trust gauge PR5<br/>✅ PR 83 → QU5 ✅ PR 84<br/>→ heartbeat outside<br/>the app PR12 (local,<br/>rides last)"]
...
1. **Wave 1 — trust + liveness + notes funnel** (= the Planned column; the standing picks,
   order confirmed): QU12 didn't-run banner (✅ 2026-07-19, PR #82) → PR5 sweep-trust gauge
   (✅ 2026-07-19, PR #83) → QU5 notes-on-News (✅ 2026-07-19, PR #84) → PR12 heartbeat
   (**local-only session** — launchd install; the wave's last open item).
