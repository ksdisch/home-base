...
kanban
  ...
  next["📋 Planned"]
    trust["Wave 1 — trust +<br/>liveness: didnt-run<br/>banner QU12 ✅ PR 82 →<br/>sweep-trust gauge PR5<br/>→ heartbeat outside<br/>the app PR12 (local,<br/>rides last)"]
...
1. **Wave 1 — trust + liveness + notes funnel** (= the Planned column; the standing picks,
   ...
   QU5 notes-on-News → PR12 heartbeat (**local-only session** — launchd install).
