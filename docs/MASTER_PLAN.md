...
kanban
  ...
  doing["🔄 In progress"]
    ...
    wave2["Wave 2 — correctness<br/>sweep: 14 low bugs +<br/>hardens + FR10 ·<br/>batches 1-3 done PRs<br/>87 89 90 · remaining:<br/>offline · store ·<br/>notes UX"]
  next["📋 Planned"]
...
1. **Wave 1 — trust + liveness + notes funnel** — ✅ **COMPLETE 2026-07-19**: QU12 didn't-run
   ...
   entry).
2. **Wave 2 — correctness sweep**: the 14 non-courses bug lows + the 4 hardens + FR10 (the 4
   ...
   **Batch 3 (news resilience) ✅ shipped 2026-07-19, PR #90**: HA8 parsed-empty cache
   ...
   scout persistence gate on America/Chicago days. Remaining: offline · store · notes UX.
