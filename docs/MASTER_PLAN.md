...
kanban
  ...
  doing["🔄 In progress"]
    ...
    wave3["Wave 3 — walk and<br/>phone: QU3 resume PR<br/>95 · QU4 chips PR 96<br/>· FR15 nav survival<br/>PR 97 · next audio<br/>chapters FR4 →<br/>developing context<br/>FR13 → phone sweep<br/>trigger FR2 →<br/>yesterdays brief QU1"]
  next["📋 Planned"]
